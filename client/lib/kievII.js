(function() {
  ...
  K2.UIElement.prototype.refresh = function(engine) {
    ...
    throw ('Element ' + this.ID + ' ' + callerFunc + ' is not a function. Its type is ' + typeof this[callerFunc]);
  };
  ...
  K2.UI = function(engine, parameters) {
    ...
    this.hammer = new K2.Hammer(this.domElement, {
      drag_min_distance: 2
    });
    ...
    this.engine = K2.ENGINE.engineFactory(engine.type, {
      'target': renderTarget
    });
    ...
    this.setZIndex = function(elementID, zIndex) {
      ...
      throw ('Could not find element ID: ' + elementID);
    };
    ...
    this.setProp = function(elementID, prop, value) {
      ...
      throw ('Could not find ID: ' + elementID + ' property: ' + prop);
    };
    ...
    this.connectSlots = function(senderElement, senderSlot, receiverElement, receiverSlot, connectParameters) {
      ...
      if ((typeof this.elements[senderElement] !== 'undefined') && (typeof this.elements[receiverElement] !== 'undefined')) {
        // //Check for the slots.
        if ((typeof this.elements[senderElement].element.values[senderSlot] === 'undefined') || (typeof this.elements[receiverElement].element.values[receiverSlot] === 'undefined')) {
          throw new Error('Slot ' + senderSlot + ' or ' + receiverSlot + ' not present.');
        } else {

          //The sender & receiver element & slot exist. Do the connection.
          var receiverHash = {
            'recvElement': receiverElement,
            'recvSlot': receiverSlot
          };
    ...
    this.setValue = function(setParms) {
      var hist = [],
          receiverHash, recvElementID, recvSlot, i, RECURSIONMAX = 1000,
          elementID, value, slot, fireCallback, history, recvValue;
      ...
      if ((typeof this.connections[elementID] !== 'undefined') && (typeof this.connections[elementID][slot] !== 'undefined')) {
        ...
        for (i in this.connections[elementID][slot]) {
          ...
          if (this.connections[elementID][slot].hasOwnProperty(i)) {
            ...
            this.setValue({
              elementID: recvElementID,
              slot: recvSlot,
              value: recvValue,
              history: hist,
              fireCallback: fire_conn_callback
            });
          }
        }
      }
  ...
  K2.Area.prototype.getready = function(args) {
    ...
    this.dragBorders = args.dragBorders || {
      top: true,
      bottom: true,
      right: true,
      left: true
    ...
    if (this.inside) {
      if (this.move !== 'none') {
        ...
        if (this.move === 'all') {
          return ([{
            slot: 'xOffset',
            value: this.values.xOffset + xDelta
          }, {
            slot: 'yOffset',
            value: this.values.yOffset + yDelta
          }]);
        } else if (this.move === 'x') {
          return ({
            slot: 'xOffset',
  ...
  K2.Area.prototype.refresh_CANVAS2D = function(engine) {
    ...
    if (this.isVisible === true) {
      ...
      engine.context.fillRect(this.xOrigin + this.values.xOffset + halfThickness, this.values.yOffset + halfThickness, this.values.width - halfThickness * 2, this.values.height - halfThickness * 2);
      if (this.thickness > 0) {
        engine.context.strokeRect(this.xOrigin + this.values.xOffset, this.values.yOffset, this.values.width, this.values.height);
      }
    }
  };
...
*/
    ...
    if (this.started) {
      ...
      if (typeof retVal !== 'undefined') {
        return [{
          ...
          'slot': 'dragEnd',
          'value': [curr_x - this.xOrigin, curr_y - this.yOrigin]
        }];
      }
  ...
  /*K2.ClickBar.prototype.tap = K2.ClickBar.prototype.touchstart = K2.ClickBar.prototype.mousedown =*/
  K2.ClickBar.prototype.touch = function(x, y) {
  ...
  /*K2.ClickBar.prototype.release = K2.ClickBar.prototype.dragend = K2.ClickBar.prototype.mouseup*/
  K2.ClickBar.prototype.release = function(x, y) {
    ...
    if (this.isVisible === true) {
      ...
      if (this.triggered) {
        ...
        if (this.values.barvalue < this.prevValue) {
          ...
          engine.context.fillRect(this.xOrigin, this.yOrigin + (1 - this.prevValue) * this.height, this.width, this.prevValue * this.height);
          engine.context.fillStyle = this.lightColor;
          engine.context.fillRect(this.xOrigin, this.yOrigin + (1 - this.values.barvalue) * this.height, this.width, this.values.barvalue * this.height);
        } else {
          engine.context.fillStyle = this.lightColor;
          engine.context.fillRect(this.xOrigin, this.yOrigin + (1 - this.values.barvalue) * this.height, this.width, this.values.barvalue * this.height);
  ...
  K2.RotKnob.prototype.refresh_CANVAS2D = function(engine) {
    ...
    if (this.isVisible === true) {
      ...
      K2.CanvasUtils.drawRotate(engine.context, {
        image: this.image,
        x: this.xOrigin,
        y: this.yOrigin,
        rot: rot
  ...
  K2.Slider.prototype.setGraphicWrapper = function(wrapper) {
    ...
    this.drawClass = wrapper.initObject([{
      objName: 'drawImage',
  ...
  K2.Wavebox.prototype.refresh_CANVAS2D = function(engine) {
    ...
    if (this.isVisible === true) {
      ...
      var y_point, x_point, bin_size, bin_value;
  ...
  var CurveEditor = function(parameters) {
    ...
    this.callback = function() {
      ...
      return function(slot, value, element) {
        ...
        if (slot === 'held') { /* TODO maybe a context menu or something */
        }
        if (slot === 'doubletap_c') {
/* Set the last point of the selected curve to x,y, then create another curve
  ...
  var BarSelect = function(parameters) {
    ...
    this.ui.addElement(new K2.Bar(this.barArgs), {
  ...
  K2.OSC.tagToConstructor = {
    'i': function() {
      return new K2.OSC.TInt();
    },
    'f': function() {
      return new K2.OSC.TFloat();
    },
    's': function() {
      return new K2.OSC.TString();
    },
    'b': function() {
      return new K2.OSC.TBlob();
    },
    'd': function() {
      return new K2.OSC.TDouble();
    }
  };
  ...
  K2.OSCClient.prototype.sendOSC = function(oscMessage, args) {
    ...
    if (flags.sendRemote !== false) {
      if (this.oscHandler.proxyOK === true) {
        this.oscHandler.socket.emit('osc', {
          osc: binaryMsg
        });
      }
    }
  ...
  K2.loadMultipleImages = function(args) {
    ...
    for (var i = 0; i < this.multipleImages.length; i += 1) {
      ...
      var loader = {};
      loader.imageArray = new loadImageArray({
        ID: this.multipleImages[i].ID,
